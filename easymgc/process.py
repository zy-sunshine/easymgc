...
easymgc.proxy.lazyimport.lazyimport(globals(),
...
def run_exitfuncs():
    ...
    while _exithandlers:
        ...
        try:
            ...
            logger.exception("Error in easymgc.process.run_exitfuncs")
            exc_info = sys.exc_info()
...
def _exec(binary, mycommand, opt_name, fd_pipes, env, gid, groups, uid, umask,
    ...
    if not opt_name:
        if binary is easymgc._python_interpreter:
